...
# Core Properties #
nifi.flow.configuration.file=./conf/flow/flow.xml.gz
nifi.flow.configuration.json.file=./conf/flow/flow.json.gz
...
# security properties #
nifi.sensitive.props.key=Th1s1sAS3crEt
...
nifi.cluster.node.address=test-0
